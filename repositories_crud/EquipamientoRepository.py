...
class EquipamentoRepository:
    ...
    def crear_equipamiento(self, equipamiento):
        ...
        try:
            ...
            cursor.execute("""
                INSERT INTO equipamiento (numEquipa, nombre, costoRenta, stock, esta_equipa, tipo_equipa)
                VALUES (%s, %s, %s, %s, %s, %s)
                """, (equipamiento.numEquipa, equipamiento.nombre, equipamiento.costoRenta, equipamiento.stock, equipamiento.esta_equipa, equipamiento.tipo_equipa))
