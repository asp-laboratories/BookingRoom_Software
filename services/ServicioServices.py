...
class ServicioService:  # Clase que ayudara a gestionar las operaciones de la base de datos.
    ...
    def registrar_servicio(
    ...
    ):  # Metodo para registrar un servicio que en tests/test_servicio.py hay un
        ...
        servicio = Servicio(
            nombre, descripcion, costo_renta, descripciont.codigoTiSer
        )  # Mediante los parametros obtenidos creamos un objeto llamando a la clase Servicio en
    ...
    def listar_servicio_busqueda(
        self, numServicio
    ):  # Metodo para listar los datos a pantalla.
        print("Servicios: ")
        return self.servicio_repository.listar_servicio_buscar(
            numServicio
        )  # Recordando que devuelve un diccionario
