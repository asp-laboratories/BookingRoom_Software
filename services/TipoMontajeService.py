...
class TipoMontajeService:
    ...
    def listar_mobiliarios_montaje(self, montaje):
        ...
        if montaje:
            resultado = self.TipoMontajeRepository.mobiliarios_por_montaje(
                montaje["codigoMon"]
            )
        else:
            return None
        ...
        for nombreSalon in nombresSalones:
            salon = {"nombre": nombreSalon, "mobiliarios": []}
    ...
    def listar_mobiliarios_salon(self, nombre_salon):
        ...
        for nombreMonatje in nombresMontajes:
            montaje = {"nombre": nombreMonatje, "mobiliarios": []}
    ...
    def obtener_datos_montaje(self, tipo_montaje, datos_salon):
        ...
        datos_montaje = DatosMontaje(
            tipo_montaje=tipo_montaje["codigoMon"], datos_salon=datos_salon
        )
        numDatMon = self.DatosMontajeRepository.obtener_codigo_datos_montaje(
            datos_montaje
        )
