...
def registro_equipamento():
    while True:
        ...
        costoRenta = float(
            input("Ingrese el costo del equipamento \n")
        ...
        if equipamento.registrar_equipamento(
            nombre=nombre,
...
def actualizar_estado():
    equipamento.actualizar_estado_equipamiento(
        "microfono inala", "disponible", "no disponible", 1
    )
...
def main():
    ...
    while True:
        ...
        match respuesta:
            ...
            case 1:
                print(
                    "Registro de un nuevo Equipamento"
                )  #  Por defualt se queda en disponivble
