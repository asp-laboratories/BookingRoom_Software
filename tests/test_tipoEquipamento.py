    ...
    while True:
        ...
        match respuesta:
            case 1:
                ...
                descripcion_tEquipa = input(
                    "Ingrese la descripcion del tipo de equipamento: \n"
                )
                Tequipamento.registrar_tipo_equipamento(
                    codigo_equipa, descripcion_tEquipa
                )
            case 2:
                print("Saliendo")
                break
